...
#nullable enable
                ...
                out MethodSymbol? falseOperator)
            {
                ...
                if (!TypeSymbol.Equals(signature.LeftType, signature.RightType, TypeCompareKind.AllIgnoreOptions) && TypeSymbol.Equals(signature.LeftType, signature.ReturnType, TypeCompareKind.AllIgnoreOptions) ||
