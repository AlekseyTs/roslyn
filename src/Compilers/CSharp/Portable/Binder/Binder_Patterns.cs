            ...
            if (node.PositionalPatternClause != null)
            {
                ...
                else
                {
                        ...
                        ShouldUseITupleForRecursivePattern(node, declType, diagnostics, out var iTupleType, out var iTupleGetLength, out var iTupleGetItem))
                    {
                        ...
                        unionType = null;
                        return new BoundITuplePattern(node, iTupleGetLength, iTupleGetItem, deconstructionSubpatterns, isUnionMatching: unionMatchingMode == UnionMatchingMode.UnionValue, inputType: inputType, iTupleType, hasErrors);
                    }
                    else
                    {
