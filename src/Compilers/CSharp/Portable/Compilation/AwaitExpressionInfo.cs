...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    public struct AwaitExpressionInfo : IEquatable<AwaitExpressionInfo>
    {
        ...
        public IMethodSymbol GetAwaiterMethod => _awaitableInfo?.GetAwaiter.GetPublicSymbol();

        public IPropertySymbol IsCompletedProperty => _awaitableInfo?.IsCompleted.GetPublicSymbol();

        public IMethodSymbol GetResultMethod => _awaitableInfo?.GetResult.GetPublicSymbol();
