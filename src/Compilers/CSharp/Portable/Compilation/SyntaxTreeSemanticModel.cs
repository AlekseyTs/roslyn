...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    internal partial class SyntaxTreeSemanticModel : CSharpSemanticModel
    {
        ...
        private ConsList<TypeSymbol> GetBasesBeingResolved(TypeSyntax expression)
        {
            ...
            for (; expression != null && expression.Parent != null; expression = expression.Parent as TypeSyntax)
            {
                ...
                if (parent is BaseTypeSyntax baseType && parent.Parent != null && parent.Parent.Kind() == SyntaxKind.BaseList && baseType.Type == expression)
                {
                    ...
                    return ConsList<TypeSymbol>.Empty.Prepend(symbol.OriginalDefinition.GetSymbol<TypeSymbol>());
                }
            }
        ...
        {
            var csdestination = destination.EnsureCSharpSymbolOrNull<ITypeSymbol, Symbols.PublicModel.TypeSymbol>(nameof(destination))?.UnderlyingTypeSymbol;
        ...
        public override INamespaceSymbol GetDeclaredSymbol(NamespaceDeclarationSyntax declarationSyntax, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return GetDeclaredNamespace(declarationSyntax).GetPublicSymbol<INamespaceSymbol>();
        }
        ...
        private NamespaceSymbol GetDeclaredNamespace(NamespaceDeclarationSyntax declarationSyntax)
        {
            ...
            symbol = _compilation.GetCompilationNamespace(symbol.GetPublicSymbol<INamespaceSymbol>());
            Debug.Assert((object)symbol != null);
        ...
        public override INamedTypeSymbol GetDeclaredSymbol(BaseTypeDeclarationSyntax declarationSyntax, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return GetDeclaredType(declarationSyntax).GetPublicSymbol<INamedTypeSymbol>();
        }
        ...
        public override ISymbol GetDeclaredSymbol(MemberDeclarationSyntax declarationSyntax, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            switch (declarationSyntax.Kind())
            {
                ...
                default:
                    return (GetDeclaredNamespaceOrType(declarationSyntax) ?? GetDeclaredMemberSymbol(declarationSyntax)).GetPublicSymbol<ISymbol>();
            }
        }
        ...
        {
            return GetDeclaredMemberSymbol(declarationSyntax).GetPublicSymbol<IFieldSymbol>();
        }
        ...
        {
            return GetDeclaredMemberSymbol(declarationSyntax).GetPublicSymbol<IMethodSymbol>();
        }
        ...
        {
            return GetDeclaredMemberSymbol(declarationSyntax).GetPublicSymbol<ISymbol>();
        }
        ...
        {
            return GetDeclaredMemberSymbol(declarationSyntax).GetPublicSymbol<IPropertySymbol>();
        }
        ...
        {
            return GetDeclaredMemberSymbol(declarationSyntax).GetPublicSymbol<IEventSymbol>();
        }
        ...
        public override IMethodSymbol GetDeclaredSymbol(AccessorDeclarationSyntax declarationSyntax, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            switch (propertyOrEventDecl.Kind())
            {
                ...
                case SyntaxKind.EventFieldDeclaration:
                    ...
                    return (this.GetDeclaredMember(container, declarationSyntax.Span) as MethodSymbol).GetPublicSymbol<IMethodSymbol>();
        ...
        public override ISymbol GetDeclaredSymbol(VariableDeclaratorSyntax declarationSyntax, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (field != null)
            {
                ...
                return result.GetPublicSymbol<ISymbol>();
            }
        ...
        public override ISymbol GetDeclaredSymbol(SingleVariableDesignationSyntax declarationSyntax, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return binder?.LookupDeclaredField(declarationSyntax).GetPublicSymbol<ISymbol>();
        }
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            else if (alias.Alias.Locations[0].SourceSpan == declarationSyntax.Alias.Name.Span)
            {
                ...
                return alias.Alias.GetPublicSymbol<IAliasSymbol>();
            }
            else
            {
                // Case: multiple aliases, not the first (see DevDiv #9368)
                return new AliasSymbol(binder, declarationSyntax).GetPublicSymbol<IAliasSymbol>();
            }
        }
            ...
            CancellationToken cancellationToken)
        {
            ...
            method = (GetDeclaredSymbol(memberDecl, cancellationToken) as IMethodSymbol)?.GetSymbol<MethodSymbol>();
            ...
            CancellationToken cancellationToken)
        {
            ...
            var property = (GetDeclaredSymbol(memberDecl, cancellationToken) as IPropertySymbol)?.GetSymbol<PropertySymbol>();
            ...
            CancellationToken cancellationToken)
        {
            ...
            var delegateType = (GetDeclaredSymbol(memberDecl, cancellationToken) as INamedTypeSymbol).GetSymbol<NamedTypeSymbol>();
        ...
        public override IParameterSymbol GetDeclaredSymbol(ParameterSyntax declarationSyntax, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return GetDeclaredNonLambdaParameterSymbol(declarationSyntax, cancellationToken).GetPublicSymbol<IParameterSymbol>();
        }
            ...
            if (typeParameter.Parent is TypeParameterListSyntax typeParamList)
            {
                ...
                switch (parameterizedSymbol.GetSymbol())
                {
                    case NamedTypeSymbol typeSymbol:
                        return this.GetTypeParameterSymbol(typeSymbol.TypeParameters, typeParameter).GetPublicSymbol<ITypeParameterSymbol>();
                    ...
                    case MethodSymbol methodSymbol:
                        return (this.GetTypeParameterSymbol(methodSymbol.TypeParameters, typeParameter) ??
                            ((object)methodSymbol.PartialDefinitionPart == null
                                ? null
                                : this.GetTypeParameterSymbol(methodSymbol.PartialDefinitionPart.TypeParameters, typeParameter))).GetPublicSymbol<ITypeParameterSymbol>();
                }
            }
