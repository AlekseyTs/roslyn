        ...
        internal static bool CanBePassedByReference(BoundExpression expr)
        {
            ...
            switch (expr.Kind)
            {
                ...
                case BoundKind.FixedSizeBufferElementAccess:
                    return ((BoundFixedSizeBufferElementAccess)expr) is { IsValue: false, GetItemOrSliceHelper: WellKnownMember.System_Span_T__get_Item or WellKnownMember.System_ReadOnlySpan_T__get_Item };
