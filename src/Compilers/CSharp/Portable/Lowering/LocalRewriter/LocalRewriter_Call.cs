    ...
    internal sealed partial class LocalRewriter
    {
            ...
            bool invokedAsExtensionMethod)
        {
            ...
            if (CanSkipRewriting(arguments, methodOrIndexer, expanded, argsToParamsOpt, invokedAsExtensionMethod, true, out _))
            {
                ...
                {
                    argumentsBuilder.Add(operationFactory.CreateArgumentOperation(ArgumentKind.Explicit, parameters[i].GetPublicSymbol<IParameterSymbol>(), arguments[i]));
                }
            ...
            Binder binder)
        {
            ...
            for (int a = 0; a < arguments.Length; ++a)
            {
                ...
                argumentsInEvaluationBuilder.Add(operationFactory.CreateArgumentOperation(kind, parameter.GetPublicSymbol<IParameterSymbol>(), argument));
            }
            ...
            ArrayBuilder<IArgumentOperation> argumentsBuilder)
        {
            ...
            foreach (ParameterSymbol parameter in missingParameters)
            {
                ...
                argumentsBuilder.Add(operationFactory.CreateArgumentOperation(kind, parameter.GetPublicSymbol<IParameterSymbol>(), argument));
            }
        }
