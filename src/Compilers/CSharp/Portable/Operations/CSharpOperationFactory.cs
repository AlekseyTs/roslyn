...
namespace Microsoft.CodeAnalysis.Operations
{
    internal sealed partial class CSharpOperationFactory
    {
        ...
        {
            return new CSharpLazyConstructorBodyOperation(this, boundNode, boundNode.Locals.GetPublicSymbols<LocalSymbol, ILocalSymbol>(), _semanticModel, boundNode.Syntax);
        }
        ...
        private IPlaceholderOperation CreateBoundDeconstructValuePlaceholderOperation(BoundDeconstructValuePlaceholder boundDeconstructValuePlaceholder)
        {
            ...
            ITypeSymbol type = boundDeconstructValuePlaceholder.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IDeconstructionAssignmentOperation CreateBoundDeconstructionAssignmentOperator(BoundDeconstructionAssignmentOperator boundDeconstructionAssignmentOperator)
        {
            ...
            ITypeSymbol type = boundDeconstructionAssignmentOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IOperation CreateBoundCallOperation(BoundCall boundCall)
        {
            ...
            ITypeSymbol type = boundCall.Type.GetPublicSymbol<ITypeSymbol>();
            ...
            return new CSharpLazyInvocationOperation(this, boundCall, targetMethod.GetPublicSymbol<IMethodSymbol>(), isVirtual, _semanticModel, syntax, type, constantValue, isImplicit);
        }
        ...
        {
            ILocalSymbol local = boundLocal.LocalSymbol.GetPublicSymbol<ILocalSymbol>();
            bool isDeclaration = boundLocal.DeclarationKind != BoundLocalDeclarationKind.None;
            SyntaxNode syntax = boundLocal.Syntax;
            ITypeSymbol type = boundLocal.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        {
            IFieldSymbol field = boundFieldAccess.FieldSymbol.GetPublicSymbol<IFieldSymbol>();
            ...
            ITypeSymbol type = boundFieldAccess.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IPropertyReferenceOperation CreateBoundPropertyAccessOperation(BoundPropertyAccess boundPropertyAccess)
        {
            ...
            IPropertySymbol property = boundPropertyAccess.PropertySymbol.GetPublicSymbol<IPropertySymbol>();
            SyntaxNode syntax = boundPropertyAccess.Syntax;
            ITypeSymbol type = boundPropertyAccess.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IOperation CreateBoundIndexerAccessOperation(BoundIndexerAccess boundIndexerAccess)
        {
            ...
            ITypeSymbol type = boundIndexerAccess.Type.GetPublicSymbol<ITypeSymbol>();
            ...
            return new CSharpLazyPropertyReferenceOperation(this, boundIndexerAccess, isObjectOrCollectionInitializer, property.GetPublicSymbol<IPropertySymbol>(), _semanticModel, syntax, type, constantValue, isImplicit);
        }

        private IEventReferenceOperation CreateBoundEventAccessOperation(BoundEventAccess boundEventAccess)
        {
            IEventSymbol @event = boundEventAccess.EventSymbol.GetPublicSymbol<IEventSymbol>();
            BoundNode instance = boundEventAccess.ReceiverOpt;
            SyntaxNode syntax = boundEventAccess.Syntax;
            ITypeSymbol type = boundEventAccess.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IEventAssignmentOperation CreateBoundEventAssignmentOperatorOperation(BoundEventAssignmentOperator boundEventAssignmentOperator)
        {
            ...
            ITypeSymbol type = boundEventAssignmentOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        {
            IParameterSymbol parameter = boundParameter.ParameterSymbol.GetPublicSymbol<IParameterSymbol>();
            SyntaxNode syntax = boundParameter.Syntax;
            ITypeSymbol type = boundParameter.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        internal ILiteralOperation CreateBoundLiteralOperation(BoundLiteral boundLiteral, bool @implicit = false)
        {
            ...
            ITypeSymbol type = boundLiteral.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IAnonymousObjectCreationOperation CreateBoundAnonymousObjectCreationExpressionOperation(BoundAnonymousObjectCreationExpression boundAnonymousObjectCreationExpression)
        {
            ...
            ITypeSymbol type = boundAnonymousObjectCreationExpression.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IOperation CreateBoundObjectCreationExpressionOperation(BoundObjectCreationExpression boundObjectCreationExpression)
        {
            ...
            ITypeSymbol type = boundObjectCreationExpression.Type.GetPublicSymbol<ITypeSymbol>();
            ...
            return new CSharpLazyObjectCreationOperation(this, boundObjectCreationExpression, constructor.GetPublicSymbol<IMethodSymbol>(), _semanticModel, syntax, type, constantValue, isImplicit);
        }
        ...
        private IDynamicObjectCreationOperation CreateBoundDynamicObjectCreationExpressionOperation(BoundDynamicObjectCreationExpression boundDynamicObjectCreationExpression)
        {
            ...
            ITypeSymbol type = boundDynamicObjectCreationExpression.Type.GetPublicSymbol<ITypeSymbol>();
            ...
            switch (receiver)
            {
                ...
                case BoundMethodGroup methodGroup:
                    return CreateBoundDynamicMemberAccessOperation(methodGroup.ReceiverOpt, TypeMap.AsTypeSymbols(methodGroup.TypeArgumentsOpt), methodGroup.Name,
                                                                   methodGroup.Syntax, methodGroup.Type.GetPublicSymbol<ITypeSymbol>(), methodGroup.ConstantValue, methodGroup.WasCompilerGenerated);
        ...
        private IDynamicInvocationOperation CreateBoundDynamicInvocationExpressionOperation(BoundDynamicInvocation boundDynamicInvocation)
        {
            ...
            ITypeSymbol type = boundDynamicInvocation.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IDynamicIndexerAccessOperation CreateBoundDynamicIndexerAccessExpressionOperation(BoundDynamicIndexerAccess boundDynamicIndexerAccess)
        {
            ...
            ITypeSymbol type = boundDynamicIndexerAccess.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IObjectOrCollectionInitializerOperation CreateBoundObjectInitializerExpressionOperation(BoundObjectInitializerExpression boundObjectInitializerExpression)
        {
            ...
            ITypeSymbol type = boundObjectInitializerExpression.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IObjectOrCollectionInitializerOperation CreateBoundCollectionInitializerExpressionOperation(BoundCollectionInitializerExpression boundCollectionInitializerExpression)
        {
            ...
            ITypeSymbol type = boundCollectionInitializerExpression.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IOperation CreateBoundObjectInitializerMemberOperation(BoundObjectInitializerMember boundObjectInitializerMember, bool isObjectOrCollectionInitializer = false)
        {
            ...
            ITypeSymbol type = boundObjectInitializerMember.Type.GetPublicSymbol<ITypeSymbol>();
            ...
            switch (memberSymbol.Kind)
            {
                case SymbolKind.Field:
                    ...
                    return new FieldReferenceOperation(field.GetPublicSymbol<IFieldSymbol>(), isDeclaration, createReceiver(), _semanticModel, syntax, type, constantValue, isImplicit);
                case SymbolKind.Event:
                    var eventSymbol = (EventSymbol)memberSymbol;
                    return new EventReferenceOperation(eventSymbol.GetPublicSymbol<IEventSymbol>(), createReceiver(), _semanticModel, syntax, type, constantValue, isImplicit);
                case SymbolKind.Property:
                    ...
                    return new CSharpLazyPropertyReferenceOperation(this, boundObjectInitializerMember, isObjectOrCollectionInitializer: true, property.GetPublicSymbol<IPropertySymbol>(), _semanticModel, syntax, type, constantValue, isImplicit);
                default:
                    throw ExceptionUtilities.Unreachable;
            }
        ...
        private IOperation CreateBoundDynamicObjectInitializerMemberOperation(BoundDynamicObjectInitializerMember boundDynamicObjectInitializerMember)
        {
            ...
            ITypeSymbol containingType = boundDynamicObjectInitializerMember.ReceiverType.GetPublicSymbol<ITypeSymbol>();
            SyntaxNode syntax = boundDynamicObjectInitializerMember.Syntax;
            ITypeSymbol type = boundDynamicObjectInitializerMember.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IOperation CreateBoundCollectionElementInitializerOperation(BoundCollectionElementInitializer boundCollectionElementInitializer)
        {
            ...
            ITypeSymbol type = boundCollectionElementInitializer.Type.GetPublicSymbol<ITypeSymbol>();
            ...
            return new CSharpLazyInvocationOperation(this, boundCollectionElementInitializer, addMethod.GetPublicSymbol<IMethodSymbol>(), isVirtual, _semanticModel, syntax, type, constantValue, isImplicit);
        }
        ...
        private IDynamicMemberReferenceOperation CreateBoundDynamicMemberAccessOperation(BoundDynamicMemberAccess boundDynamicMemberAccess)
        {
            return CreateBoundDynamicMemberAccessOperation(boundDynamicMemberAccess.Receiver, TypeMap.AsTypeSymbols(boundDynamicMemberAccess.TypeArgumentsOpt), boundDynamicMemberAccess.Name,
                boundDynamicMemberAccess.Syntax, boundDynamicMemberAccess.Type.GetPublicSymbol<ITypeSymbol>(), boundDynamicMemberAccess.ConstantValue, boundDynamicMemberAccess.WasCompilerGenerated);
        }
            ...
            bool isImplicit)
        {
            ...
            {
                containingType = receiverOpt.Type.GetPublicSymbol<ITypeSymbol>();
                receiverOpt = null;
            }
            ...
            {
                typeArguments = typeArgumentsOpt.SelectAsArray(a => a.GetPublicSymbol<ITypeSymbol>());
            }
        ...
        {
            IMethodSymbol symbol = boundLambda.Symbol.GetPublicSymbol<IMethodSymbol>();
        ...
        {
            IMethodSymbol symbol = boundLocalFunctionStatement.Symbol.GetPublicSymbol<IMethodSymbol>();
        ...
        private IOperation CreateBoundConversionOperation(BoundConversion boundConversion)
        {
            ...
            if (boundConversion.ConversionKind == CSharp.ConversionKind.MethodGroup)
            {
                ...
                ITypeSymbol type = boundConversion.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IConversionOperation CreateBoundAsOperatorOperation(BoundAsOperator boundAsOperator)
        {
            ...
            ITypeSymbol type = boundAsOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IDelegateCreationOperation CreateBoundDelegateCreationExpressionOperation(BoundDelegateCreationExpression boundDelegateCreationExpression)
        {
            ...
            ITypeSymbol type = boundDelegateCreationExpression.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IMethodReferenceOperation CreateBoundMethodGroupSingleMethodOperation(BoundMethodGroup boundMethodGroup, MethodSymbol methodSymbol, bool suppressVirtualCalls)
        {
            ...
            return new CSharpLazyMethodReferenceOperation(this, instance, methodSymbol.GetPublicSymbol<IMethodSymbol>(), isVirtual, _semanticModel, bindingSyntax, bindingType, bindingConstantValue, boundMethodGroup.WasCompilerGenerated);
        }
        ...
        private IIsTypeOperation CreateBoundIsOperatorOperation(BoundIsOperator boundIsOperator)
        {
            ...
            ITypeSymbol typeOperand = boundIsOperator.TargetType.Type.GetPublicSymbol<ITypeSymbol>();
            SyntaxNode syntax = boundIsOperator.Syntax;
            ITypeSymbol type = boundIsOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        {
            ITypeSymbol typeOperand = boundSizeOfOperator.SourceType.Type.GetPublicSymbol<ITypeSymbol>();
            SyntaxNode syntax = boundSizeOfOperator.Syntax;
            ITypeSymbol type = boundSizeOfOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        {
            ITypeSymbol typeOperand = boundTypeOfOperator.SourceType.Type.GetPublicSymbol<ITypeSymbol>();
            SyntaxNode syntax = boundTypeOfOperator.Syntax;
            ITypeSymbol type = boundTypeOfOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IArrayCreationOperation CreateBoundArrayCreationOperation(BoundArrayCreation boundArrayCreation)
        {
            ...
            ITypeSymbol type = boundArrayCreation.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IDefaultValueOperation CreateBoundDefaultExpressionOperation(BoundDefaultExpression boundDefaultExpression)
        {
            ...
            ITypeSymbol type = boundDefaultExpression.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IInstanceReferenceOperation CreateBoundBaseReferenceOperation(BoundBaseReference boundBaseReference)
        {
            ...
            ITypeSymbol type = boundBaseReference.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IInstanceReferenceOperation CreateBoundThisReferenceOperation(BoundThisReference boundThisReference)
        {
            ...
            ITypeSymbol type = boundThisReference.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private ISimpleAssignmentOperation CreateBoundAssignmentOperatorOperation(BoundAssignmentOperator boundAssignmentOperator)
        {
            ...
            ITypeSymbol type = boundAssignmentOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private ICompoundAssignmentOperation CreateBoundCompoundAssignmentOperatorOperation(BoundCompoundAssignmentOperator boundCompoundAssignmentOperator)
        {
            ...
            IMethodSymbol operatorMethod = boundCompoundAssignmentOperator.Operator.Method.GetPublicSymbol<IMethodSymbol>();
            SyntaxNode syntax = boundCompoundAssignmentOperator.Syntax;
            ITypeSymbol type = boundCompoundAssignmentOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IIncrementOrDecrementOperation CreateBoundIncrementOperatorOperation(BoundIncrementOperator boundIncrementOperator)
        {
            ...
            IMethodSymbol operatorMethod = boundIncrementOperator.MethodOpt.GetPublicSymbol<IMethodSymbol>();
            SyntaxNode syntax = boundIncrementOperator.Syntax;
            ITypeSymbol type = boundIncrementOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IInvalidOperation CreateBoundBadExpressionOperation(BoundBadExpression boundBadExpression)
        {
            ...
            ITypeSymbol type = syntax.IsMissing ? null : boundBadExpression.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private ITypeParameterObjectCreationOperation CreateBoundNewTOperation(BoundNewT boundNewT)
        {
            ...
            ITypeSymbol type = boundNewT.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private INoPiaObjectCreationOperation CreateNoPiaObjectCreationExpressionOperation(BoundNoPiaObjectCreationExpression creation)
        {
            ...
            ITypeSymbol type = creation.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IUnaryOperation CreateBoundUnaryOperatorOperation(BoundUnaryOperator boundUnaryOperator)
        {
            ...
            IMethodSymbol operatorMethod = boundUnaryOperator.MethodOpt.GetPublicSymbol<IMethodSymbol>();
            SyntaxNode syntax = boundUnaryOperator.Syntax;
            ITypeSymbol type = boundUnaryOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IBinaryOperation CreateBoundBinaryOperatorOperation(BoundBinaryOperator boundBinaryOperator)
        {
            ...
            IMethodSymbol operatorMethod = boundBinaryOperator.MethodOpt.GetPublicSymbol<IMethodSymbol>();
            ...
            ITypeSymbol type = boundBinaryOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        {
            BinaryOperatorKind operatorKind = Helper.DeriveBinaryOperatorKind(boundBinaryOperator.OperatorKind);
            IMethodSymbol operatorMethod = boundBinaryOperator.LogicalOperator.GetPublicSymbol<IMethodSymbol>();
            IMethodSymbol unaryOperatorMethod = boundBinaryOperator.OperatorKind.Operator() == CSharp.BinaryOperatorKind.And ?
                                                    boundBinaryOperator.FalseOperator.GetPublicSymbol<IMethodSymbol>() :
                                                    boundBinaryOperator.TrueOperator.GetPublicSymbol<IMethodSymbol>();
            SyntaxNode syntax = boundBinaryOperator.Syntax;
            ITypeSymbol type = boundBinaryOperator.Type.GetPublicSymbol<ITypeSymbol>();
            Optional<object> constantValue = ConvertToOptional(boundBinaryOperator.ConstantValue);
            bool isLifted = boundBinaryOperator.OperatorKind.IsLifted();
        ...
        private ITupleBinaryOperation CreateBoundTupleBinaryOperatorOperation(BoundTupleBinaryOperator boundTupleBinaryOperator)
        {
            ...
            ITypeSymbol type = boundTupleBinaryOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IConditionalOperation CreateBoundConditionalOperatorOperation(BoundConditionalOperator boundConditionalOperator)
        {
            ...
            ITypeSymbol type = boundConditionalOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private ICoalesceOperation CreateBoundNullCoalescingOperatorOperation(BoundNullCoalescingOperator boundNullCoalescingOperator)
        {
            ...
            ITypeSymbol type = boundNullCoalescingOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IOperation CreateBoundNullCoalescingAssignmentOperatorOperation(BoundNullCoalescingAssignmentOperator boundNode)
        {
            ...
            ITypeSymbol type = boundNode.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IAwaitOperation CreateBoundAwaitExpressionOperation(BoundAwaitExpression boundAwaitExpression)
        {
            ...
            ITypeSymbol type = boundAwaitExpression.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IArrayElementReferenceOperation CreateBoundArrayAccessOperation(BoundArrayAccess boundArrayAccess)
        {
            ...
            ITypeSymbol type = boundArrayAccess.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private INameOfOperation CreateBoundNameOfOperatorOperation(BoundNameOfOperator boundNameOfOperator)
        {
            ...
            ITypeSymbol type = boundNameOfOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IThrowOperation CreateBoundThrowExpressionOperation(BoundThrowExpression boundThrowExpression)
        {
            ...
            ITypeSymbol type = boundThrowExpression.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IAddressOfOperation CreateBoundAddressOfOperatorOperation(BoundAddressOfOperator boundAddressOfOperator)
        {
            ...
            ITypeSymbol type = boundAddressOfOperator.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IInstanceReferenceOperation CreateBoundImplicitReceiverOperation(BoundImplicitReceiver boundImplicitReceiver)
        {
            ...
            ITypeSymbol type = boundImplicitReceiver.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IConditionalAccessOperation CreateBoundConditionalAccessOperation(BoundConditionalAccess boundConditionalAccess)
        {
            ...
            ITypeSymbol type = boundConditionalAccess.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IConditionalAccessInstanceOperation CreateBoundConditionalReceiverOperation(BoundConditionalReceiver boundConditionalReceiver)
        {
            ...
            ITypeSymbol type = boundConditionalReceiver.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        {
            ImmutableArray<IFieldSymbol> initializedFields = ImmutableArray.Create<IFieldSymbol>(boundFieldEqualsValue.Field.GetPublicSymbol<IFieldSymbol>());
            ...
            return new CSharpLazyFieldInitializerOperation(this, value, boundFieldEqualsValue.Locals.GetPublicSymbols<LocalSymbol, ILocalSymbol>(), initializedFields, kind, _semanticModel, syntax, type, constantValue, isImplicit);
        }
        ...
        {
            ImmutableArray<IPropertySymbol> initializedProperties = ImmutableArray.Create<IPropertySymbol>(boundPropertyEqualsValue.Property.GetPublicSymbol<IPropertySymbol>());
            ...
            return new CSharpLazyPropertyInitializerOperation(this, value, boundPropertyEqualsValue.Locals.GetPublicSymbols<LocalSymbol, ILocalSymbol>(), initializedProperties, _semanticModel, syntax, type, constantValue, isImplicit);
        }
        ...
        {
            IParameterSymbol parameter = boundParameterEqualsValue.Parameter.GetPublicSymbol<IParameterSymbol>();
            ...
            return new CSharpLazyParameterInitializerOperation(this, value, boundParameterEqualsValue.Locals.GetPublicSymbols<LocalSymbol, ILocalSymbol>(), parameter, kind, _semanticModel, syntax, type, constantValue, isImplicit);
        }

        private IBlockOperation CreateBoundBlockOperation(BoundBlock boundBlock)
        {
            ImmutableArray<ILocalSymbol> locals = boundBlock.Locals.GetPublicSymbols<LocalSymbol, ILocalSymbol>();
        ...
        {
            ILabelSymbol target = boundContinueStatement.Label.GetPublicSymbol<ILabelSymbol>();
        ...
        {
            ILabelSymbol target = boundBreakStatement.Label.GetPublicSymbol<ILabelSymbol>();
        ...
        {
            ILabelSymbol target = boundGotoStatement.Label.GetPublicSymbol<ILabelSymbol>();
        ...
        {
            ImmutableArray<ILocalSymbol> locals = boundWhileStatement.Locals.GetPublicSymbols<LocalSymbol, ILocalSymbol>();
            ILabelSymbol continueLabel = boundWhileStatement.ContinueLabel.GetPublicSymbol<ILabelSymbol>();
            ILabelSymbol exitLabel = boundWhileStatement.BreakLabel.GetPublicSymbol<ILabelSymbol>();
        ...
        {
            ILabelSymbol continueLabel = boundDoStatement.ContinueLabel.GetPublicSymbol<ILabelSymbol>();
            ILabelSymbol exitLabel = boundDoStatement.BreakLabel.GetPublicSymbol<ILabelSymbol>();
            bool conditionIsTop = false;
            bool conditionIsUntil = false;
            ImmutableArray<ILocalSymbol> locals = boundDoStatement.Locals.GetPublicSymbols<LocalSymbol, ILocalSymbol>();
        ...
        {
            ImmutableArray<ILocalSymbol> locals = boundForStatement.OuterLocals.GetPublicSymbols<LocalSymbol, ILocalSymbol>();
            ImmutableArray<ILocalSymbol> conditionLocals = boundForStatement.InnerLocals.GetPublicSymbols<LocalSymbol, ILocalSymbol>();
            ILabelSymbol continueLabel = boundForStatement.ContinueLabel.GetPublicSymbol<ILabelSymbol>();
            ILabelSymbol exitLabel = boundForStatement.BreakLabel.GetPublicSymbol<ILabelSymbol>();
        ...
        internal ForEachLoopOperationInfo GetForEachLoopOperatorInfo(BoundForEachStatement boundForEachStatement)
        {
            ...
            if (enumeratorInfoOpt != null)
            {
                ...
                info = new ForEachLoopOperationInfo(enumeratorInfoOpt.ElementType.GetPublicSymbol<ITypeSymbol>(),
                                                    enumeratorInfoOpt.GetEnumeratorMethod.GetPublicSymbol<IMethodSymbol>(),
                                                    enumeratorInfoOpt.CurrentPropertyGetter.AssociatedSymbol.GetPublicSymbol<IPropertySymbol>(),
                                                    enumeratorInfoOpt.MoveNextMethod.GetPublicSymbol<IMethodSymbol>(),
        ...
        internal IOperation CreateBoundForEachStatementLoopControlVariable(BoundForEachStatement boundForEachStatement)
        {
            ...
            else
            {
                ...
                return new VariableDeclaratorOperation(local.GetPublicSymbol<ILocalSymbol>(), initializer: null, ignoredArguments: ImmutableArray<IOperation>.Empty, semanticModel: _semanticModel, syntax: declaratorSyntax, type: null, constantValue: default, isImplicit: false);
            }
        }

        private IForEachLoopOperation CreateBoundForEachStatementOperation(BoundForEachStatement boundForEachStatement)
        {
            ImmutableArray<ILocalSymbol> locals = boundForEachStatement.IterationVariables.GetPublicSymbols<LocalSymbol, ILocalSymbol>();

            ILabelSymbol continueLabel = boundForEachStatement.ContinueLabel.GetPublicSymbol<ILabelSymbol>();
            ILabelSymbol exitLabel = boundForEachStatement.BreakLabel.GetPublicSymbol<ILabelSymbol>();
        ...
        {
            ITypeSymbol exceptionType = (boundCatchBlock.ExceptionTypeOpt ?? ((CSharpCompilation)_semanticModel.Compilation).ObjectType).GetPublicSymbol<ITypeSymbol>();
            ImmutableArray<ILocalSymbol> locals = boundCatchBlock.Locals.GetPublicSymbols<LocalSymbol, ILocalSymbol>();
        ...
        {
            ImmutableArray<ILocalSymbol> locals = boundFixedStatement.Locals.GetPublicSymbols<LocalSymbol, ILocalSymbol>();
        ...
        {
            ImmutableArray<ILocalSymbol> locals = boundUsingStatement.Locals.SelectAsArray(l => l.GetPublicSymbol<ILocalSymbol>());
        ...
        private ILockOperation CreateBoundLockStatementOperation(BoundLockStatement boundLockStatement)
        {
            ...
            ILocalSymbol lockTakenSymbol =
                legacyMode ? null : new SynthesizedLocal((_semanticModel.GetEnclosingSymbol(boundLockStatement.Syntax.SpanStart) as CSharp.Symbols.PublicModel.MethodSymbol)?.UnderlyingMethodSymbol,
                                                         ...
                                                         syntaxOpt: boundLockStatement.Argument.Syntax).GetPublicSymbol<ILocalSymbol>();
        ...
        {
            ILabelSymbol label = boundLabelStatement.Label.GetPublicSymbol<ILabelSymbol>();
        ...
        {
            ILabelSymbol label = boundLabeledStatement.Label.GetPublicSymbol<ILabelSymbol>();
        ...
        internal IOperation CreateTupleOperation(BoundTupleExpression boundTupleExpression, TypeSymbol naturalType, bool createDeclaration)
        {
            ...
            ITypeSymbol type = boundTupleExpression.Type.GetPublicSymbol<ITypeSymbol>();
            ...
            return new CSharpLazyTupleOperation(this, boundTupleExpression, _semanticModel, syntax, type, naturalType.GetPublicSymbol<ITypeSymbol>(), constantValue, isImplicit);
        }
        ...
        private IInterpolatedStringOperation CreateBoundInterpolatedStringExpressionOperation(BoundInterpolatedString boundInterpolatedString)
        {
            ...
            ITypeSymbol type = boundInterpolatedString.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IConstantPatternOperation CreateBoundConstantPatternOperation(BoundConstantPattern boundConstantPattern)
        {
            ...
            return new CSharpLazyConstantPatternOperation(inputType.GetPublicSymbol<ITypeSymbol>(), this, value, _semanticModel, syntax, isImplicit);
        }
        ...
        {
            ISymbol variable = boundDeclarationPattern.Variable.GetPublicSymbol<ISymbol>();
            if (variable == null && boundDeclarationPattern.VariableAccess?.Kind == BoundKind.DiscardExpression)
            {
                variable = ((BoundDiscardExpression)boundDeclarationPattern.VariableAccess).ExpressionSymbol.GetPublicSymbol<ISymbol>();
            }

            ITypeSymbol inputType = boundDeclarationPattern.InputType.GetPublicSymbol<ITypeSymbol>();
            bool acceptsNull = boundDeclarationPattern.IsVar;
            ITypeSymbol matchedType = acceptsNull ? null : boundDeclarationPattern.DeclaredType.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        {
            ImmutableArray<ILocalSymbol> locals = boundSwitchStatement.InnerLocals.SelectAsArray(l => l.GetPublicSymbol<ILocalSymbol>());
            ILabelSymbol exitLabel = boundSwitchStatement.BreakLabel.GetPublicSymbol<ILabelSymbol>();
        ...
        {
            ImmutableArray<ILocalSymbol> locals = boundSwitchSection.Locals.SelectAsArray(l => l.GetPublicSymbol<ILocalSymbol>());
        ...
        private ICaseClauseOperation CreateBoundSwitchLabelOperation(BoundSwitchLabel boundSwitchLabel)
        {
            ...
            if (boundSwitchLabel.Syntax.Kind() == SyntaxKind.DefaultSwitchLabel)
            {
                ...
                return new DefaultCaseClauseOperation(label.GetPublicSymbol<ILabelSymbol>(), _semanticModel, syntax, type, constantValue, isImplicit);
            }
            ...
            {
                return new CSharpLazySingleValueCaseClauseOperation(this, cp.Value, label.GetPublicSymbol<ILabelSymbol>(), _semanticModel, syntax, type, constantValue, isImplicit);
            }
            else
            {
                return new CSharpLazyPatternCaseClauseOperation(this, boundSwitchLabel, label.GetPublicSymbol<ILabelSymbol>(), _semanticModel, syntax, type, constantValue, isImplicit);
            }
        }
        ...
        private IIsPatternOperation CreateBoundIsPatternExpressionOperation(BoundIsPatternExpression boundIsPatternExpression)
        {
            ...
            ITypeSymbol type = boundIsPatternExpression.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IOperation CreateBoundQueryClauseOperation(BoundQueryClause boundQueryClause)
        {
            ...
            ITypeSymbol type = boundQueryClause.Type.GetPublicSymbol<ITypeSymbol>();
        ...
        private IOperation CreateBoundDiscardExpressionOperation(BoundDiscardExpression boundNode)
        {
            return new DiscardOperation(
                boundNode.ExpressionSymbol.GetPublicSymbol<IDiscardSymbol>(),
                _semanticModel,
                boundNode.Syntax,
                boundNode.Type.GetPublicSymbol<ITypeSymbol>(),
        ...
        private IOperation CreateFromEndIndexExpressionOperation(BoundFromEndIndexExpression boundIndex)
        {
            return new CSharpLazyUnaryOperation(
                ...
                _semanticModel,
                boundIndex.Syntax,
                boundIndex.Type.GetPublicSymbol<ITypeSymbol>(),
        ...
        private IOperation CreateRangeExpressionOperation(BoundRangeExpression boundRange)
        {
            return new CSharpLazyRangeOperation(
                ...
                _semanticModel,
                boundRange.Syntax,
                boundRange.Type.GetPublicSymbol<ITypeSymbol>(),
                boundRange.MethodOpt.GetPublicSymbol<IMethodSymbol>(),
        ...
        private IOperation CreateBoundDiscardPatternOperation(BoundDiscardPattern boundNode)
        {
            return new DiscardPatternOperation(
                boundNode.InputType.GetPublicSymbol<ITypeSymbol>(),
                _semanticModel,
                boundNode.Syntax,
                isImplicit: boundNode.WasCompilerGenerated);
        }
                ...
                case FieldSymbol field:
                    {
                        ...
                        return new FieldReferenceOperation(
                            field.GetPublicSymbol<IFieldSymbol>(), isDeclaration: false, receiver, _semanticModel, nameSyntax, field.Type.GetPublicSymbol<ITypeSymbol>(), constantValue, isImplicit: isImplicit);
                    }
                case PropertySymbol property:
                    {
                        ...
                        return new PropertyReferenceOperation(
                            property.GetPublicSymbol<IPropertySymbol>(), ImmutableArray<IArgumentOperation>.Empty, receiver, _semanticModel, nameSyntax, property.Type.GetPublicSymbol<ITypeSymbol>(),
        ...
        private IInstanceReferenceOperation CreateCollectionValuePlaceholderOperation(BoundObjectOrCollectionValuePlaceholder placeholder)
        {
            ...
            ITypeSymbol type = placeholder.Type.GetPublicSymbol<ITypeSymbol>();
