...
namespace Microsoft.CodeAnalysis.Operations
{
    internal sealed partial class CSharpOperationFactory
    {
        ...
        private IInstanceReferenceOperation CreateImplicitReceiver(SyntaxNode syntax, TypeSymbol type) =>
            new InstanceReferenceOperation(InstanceReferenceKind.ImplicitReceiver, _semanticModel, syntax, type.GetPublicSymbol<ITypeSymbol>(), constantValue: default, isImplicit: true);
        ...
        {
            ILocalSymbol symbol = boundLocalDeclaration.LocalSymbol.GetPublicSymbol<ILocalSymbol>();
        ...
        {
            return boundLocal == null ? null : new VariableDeclaratorOperation(boundLocal.LocalSymbol.GetPublicSymbol<ILocalSymbol>(), initializer: null, ignoredArguments: ImmutableArray<IOperation>.Empty, semanticModel: _semanticModel, syntax: boundLocal.Syntax, type: null, constantValue: default, isImplicit: false);
        }
        ...
        internal IEventReferenceOperation CreateBoundEventAccessOperation(BoundEventAssignmentOperator boundEventAssignmentOperator)
        {
            ...
            IEventSymbol @event = boundEventAssignmentOperator.Event.GetPublicSymbol<IEventSymbol>();
            ...
            for (int i = 0; i < arguments.Length; i++)
            {
                ...
                if (anonymousProperty is null)
                {
                    ...
                    target = new PropertyReferenceOperation(
                        property.GetPublicSymbol<IPropertySymbol>(),
                        arguments: ImmutableArray<IArgumentOperation>.Empty,
                        instance,
                        semanticModel: _semanticModel,
                        syntax: value.Syntax,
                        type: property.Type.GetPublicSymbol<ITypeSymbol>(),
                        constantValue: default,
                        isImplicit: true);
                ...
                {
                    target = new PropertyReferenceOperation(anonymousProperty.Property.GetPublicSymbol<IPropertySymbol>(),
                                                            ImmutableArray<IArgumentOperation>.Empty,
                                                            instance,
                                                            _semanticModel,
                                                            anonymousProperty.Syntax,
                                                            anonymousProperty.Type.GetPublicSymbol<ITypeSymbol>(),
