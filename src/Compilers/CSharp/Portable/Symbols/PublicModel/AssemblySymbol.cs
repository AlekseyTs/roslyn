...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.PublicModel
{
    internal abstract class AssemblySymbol : Symbol, IAssemblySymbol
    {
        ...
        INamespaceSymbol IAssemblySymbol.GlobalNamespace
        {
            get
            {
                return UnderlyingAssemblySymbol.GlobalNamespace.GetPublicSymbol<INamespaceSymbol>();
            }
        }
        ...
        IEnumerable<IModuleSymbol> IAssemblySymbol.Modules
        {
            get
            {
                ...
                {
                    yield return module.GetPublicSymbol<IModuleSymbol>();
                }
            }
        }
        ...
        {
            return UnderlyingAssemblySymbol.ResolveForwardedType(fullyQualifiedMetadataName).GetPublicSymbol<INamedTypeSymbol>();
        }
        ...
        {
            return UnderlyingAssemblySymbol.GetTypeByMetadataName(metadataName).GetPublicSymbol<INamedTypeSymbol>();
        }
