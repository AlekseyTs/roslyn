...
namespace Microsoft.CodeAnalysis.CSharp.Symbols.PublicModel
{
    internal sealed class MethodSymbol : Symbol, IMethodSymbol
    {
        ...
        ImmutableArray<ITypeParameterSymbol> IMethodSymbol.TypeParameters
        {
            get
            {
                return _underlying.TypeParameters.SelectAsArray(t => t.GetPublicSymbol<ITypeParameterSymbol>());
            }
        }
        ...
        ImmutableArray<IParameterSymbol> IMethodSymbol.Parameters
        {
            get
            {
                return _underlying.Parameters.SelectAsArray(p => p.GetPublicSymbol<IParameterSymbol>());
            }
        }
        ...
        IMethodSymbol IMethodSymbol.ConstructedFrom
        {
            get
            {
                return _underlying.ConstructedFrom.GetPublicSymbol<IMethodSymbol>();
            }
        }
        ...
        IMethodSymbol IMethodSymbol.OriginalDefinition
        {
            get
            {
                return _underlying.OriginalDefinition.GetPublicSymbol<IMethodSymbol>();
            }
        }
        ...
        IMethodSymbol IMethodSymbol.OverriddenMethod
        {
            get
            {
                return _underlying.OverriddenMethod.GetPublicSymbol<IMethodSymbol>();
            }
        }
        ...
        IMethodSymbol IMethodSymbol.ReducedFrom
        {
            get
            {
                return _underlying.ReducedFrom.GetPublicSymbol<IMethodSymbol>();
            }
        }
        ...
        ITypeSymbol IMethodSymbol.GetTypeInferredDuringReduction(ITypeParameterSymbol reducedFromTypeParameter)
        {
            return _underlying.GetTypeInferredDuringReduction(
                reducedFromTypeParameter.EnsureCSharpSymbolOrNull<ITypeParameterSymbol, Symbols.PublicModel.TypeParameterSymbol>(nameof(reducedFromTypeParameter))?.UnderlyingTypeParameterSymbol).
                GetPublicSymbol<ITypeSymbol>();
        }

        IMethodSymbol IMethodSymbol.ReduceExtensionMethod(ITypeSymbol receiverType)
        {
            return _underlying.ReduceExtensionMethod(
                receiverType.EnsureCSharpSymbolOrNull<ITypeSymbol, Symbols.PublicModel.TypeSymbol>(nameof(receiverType))?.UnderlyingTypeSymbol, compilation: null).
                GetPublicSymbol<IMethodSymbol>();
        }
        ...
        ImmutableArray<IMethodSymbol> IMethodSymbol.ExplicitInterfaceImplementations
        {
            get
            {
                return _underlying.ExplicitInterfaceImplementations.SelectAsArray(m => m.GetPublicSymbol<IMethodSymbol>());
            }
        }
        ...
        ISymbol IMethodSymbol.AssociatedSymbol
        {
            get
            {
                return _underlying.AssociatedSymbol.GetPublicSymbol<ISymbol>();
            }
        }
        ...
        {
            return _underlying.Construct(ConstructTypeArguments(typeArguments)).GetPublicSymbol<IMethodSymbol>();
        }
        ...
        {
            return _underlying.Construct(ConstructTypeArguments(typeArguments, typeArgumentNullableAnnotations)).GetPublicSymbol<IMethodSymbol>();
        }
        ...
        IMethodSymbol IMethodSymbol.PartialImplementationPart
        {
            get
            {
                return _underlying.PartialImplementationPart.GetPublicSymbol<IMethodSymbol>();
            }
        }
        ...
        IMethodSymbol IMethodSymbol.PartialDefinitionPart
        {
            get
            {
                return _underlying.PartialDefinitionPart.GetPublicSymbol<IMethodSymbol>();
            }
        }
