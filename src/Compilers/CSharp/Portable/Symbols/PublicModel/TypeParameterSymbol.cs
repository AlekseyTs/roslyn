...
#pragma warning restore IDE0055 // Fix formatting
        ...
        {
            get { return _underlying.DeclaringMethod.GetPublicSymbol<IMethodSymbol>(); }
        }

        INamedTypeSymbol ITypeParameterSymbol.DeclaringType
        {
            get { return _underlying.DeclaringType.GetPublicSymbol<INamedTypeSymbol>(); }
        }
        ...
        ImmutableArray<ITypeSymbol> ITypeParameterSymbol.ConstraintTypes
        {
            get
            {
                return _underlying.ConstraintTypesNoUseSiteDiagnostics.SelectAsArray(c => c.Type.GetPublicSymbol<ITypeSymbol>());
            }
        }
        ...
        {
            get { return _underlying.OriginalDefinition.GetPublicSymbol<ITypeParameterSymbol>(); }
        }

        ITypeParameterSymbol ITypeParameterSymbol.ReducedFrom
        {
            get { return _underlying.ReducedFrom.GetPublicSymbol<ITypeParameterSymbol>(); }
        }
