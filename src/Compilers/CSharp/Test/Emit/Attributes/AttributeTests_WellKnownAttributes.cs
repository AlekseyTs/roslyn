...
";
            ...
            Assert.False(substitutedNested.GetPublicSymbol<INamedTypeSymbol>().IsSerializable);
            ...
            Assert.True(substitutedNestedS.GetPublicSymbol<INamedTypeSymbol>().IsSerializable);
            ...
            Assert.False(topLevel.GetPublicSymbol<INamedTypeSymbol>().IsSerializable);

            var nested = comp2.GetTypeByMetadataName("MissingNested").BaseType();
            Assert.IsType<MissingMetadataTypeSymbol.Nested>(nested);
            Assert.False(nested.GetPublicSymbol<INamedTypeSymbol>().IsSerializable);
            ...
            Assert.False(constructedError.GetPublicSymbol<INamedTypeSymbol>().IsSerializable);
            ...
            Assert.False(nestedSubstitutedError.GetPublicSymbol<INamedTypeSymbol>().IsSerializable);
            ...
            Assert.False(unbound.GetPublicSymbol<INamedTypeSymbol>().IsSerializable);
            ...
            Assert.False(scriptClass.GetPublicSymbol<INamedTypeSymbol>().IsSerializable);
        }
        #endregion
