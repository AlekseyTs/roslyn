...
";
            ...
            // anonymous type
            INamedTypeSymbol iNamedType = comp.CreateAnonymousTypeSymbol(ImmutableArray.Create<ITypeSymbol>(comp.ObjectType.GetPublicSymbol<ITypeSymbol>()), ImmutableArray.Create("qq"));
            ...
            // tuple type
            iNamedType = comp.CreateTupleTypeSymbol(ImmutableArray.Create<ITypeSymbol>(comp.ObjectType.GetPublicSymbol<ITypeSymbol>(), comp.ObjectType.GetPublicSymbol<ITypeSymbol>()));
            Assert.False(iNamedType.IsReadOnly);
