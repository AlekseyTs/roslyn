...
"}\n");
        ...
        )
        {
            ...
            Assert.True(symbol1.GetSymbol<MethodSymbol>().HasSpecialName);
            ...
            Assert.Equal(1, symbol1.GetSymbol<MethodSymbol>().ParameterCount);
        ...
        )
        {
            ...
            if (result == BinaryOperatorKind.Error)
            {
                    ...
                    (leftType.IsPointerType() && (rightType.IsIntegralType() || rightType.IsCharType()))))
                {
                    ...
                    {
                        signature = new BinaryOperatorSignature(op | BinaryOperatorKind.Pointer, leftType, symbol1.Parameters[1].Type.GetSymbol<TypeSymbol>(), leftType);
                        Assert.True(symbol1.Parameters[1].Type.GetSymbol<TypeSymbol>().IsIntegralType());
                    }
                    else
                    {
                        signature = new BinaryOperatorSignature(op | BinaryOperatorKind.Pointer, symbol1.Parameters[0].Type.GetSymbol<TypeSymbol>(), rightType, rightType);
                        Assert.True(symbol1.Parameters[0].Type.GetSymbol<TypeSymbol>().IsIntegralType());
                    }
                }
                else if (op == BinaryOperatorKind.Subtraction &&
                    (leftType.IsPointerType() && (rightType.IsIntegralType() || rightType.IsCharType())))
                {
                    signature = new BinaryOperatorSignature(op | BinaryOperatorKind.String, leftType, symbol1.Parameters[1].Type.GetSymbol<TypeSymbol>(), leftType);
                    Assert.True(symbol1.Parameters[1].Type.GetSymbol<TypeSymbol>().IsIntegralType());
                }
