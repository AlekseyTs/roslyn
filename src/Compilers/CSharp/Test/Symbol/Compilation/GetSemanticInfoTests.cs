...
";
            ...
            var indexerSymbol = comp.GlobalNamespace.GetMember<NamedTypeSymbol>("C").Indexers.Where(i => i.ParameterCount == 1).Single().GetPublicSymbol<IPropertySymbol>();
...
";
            ...
            var indexerSymbol1 = comp.GlobalNamespace.GetMember<NamedTypeSymbol>("C").Indexers.Where(i => i.ParameterCount == 1).Single().GetPublicSymbol<IPropertySymbol>();
            var indexerSymbol2 = comp.GlobalNamespace.GetMember<NamedTypeSymbol>("C").Indexers.Where(i => i.ParameterCount == 2).Single().GetPublicSymbol<IPropertySymbol>();
...
";
            ...
            var reducedFrom1 = method1.GetSymbol<MethodSymbol>().CallsiteReducedFromMethod;
            ...
            var reducedFrom2 = method2.GetSymbol<MethodSymbol>().CallsiteReducedFromMethod;
