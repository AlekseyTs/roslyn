...
namespace Microsoft.CodeAnalysis.CSharp
{
    public class TypeInfoTests : CSharpTestBase
    {
        ...
        public void Equality()
        {
            ...
            var obj = c.GetSpecialType(SpecialType.System_Object).GetPublicSymbol<INamedTypeSymbol>();
            var int32 = c.GetSpecialType(SpecialType.System_Int32).GetPublicSymbol<INamedTypeSymbol>();
            ...
            var intEnum1 = c.GetSpecialType(SpecialType.System_Collections_Generic_IEnumerable_T).GetPublicSymbol<INamedTypeSymbol>().Construct(int32);
            var intEnum2 = c.GetSpecialType(SpecialType.System_Collections_Generic_IEnumerable_T).GetPublicSymbol<INamedTypeSymbol>().Construct(int32);
