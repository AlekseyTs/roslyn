...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class LoadingMethods : CSharpTestBase
    {
        ...
        public void Test1()
        {
            ...
            Assert.Same(module2, localM1.Locations.Single().MetadataModule.GetSymbol());
            ...
            Assert.Same(module4, basicC1_M1.Parameters[0].Locations.Single().MetadataModule.GetSymbol());
