...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Metadata.PE
{
    public class TypeAccessibility : CSharpTestBase
    {
        ...
        private void TestTypeAccessibilityHelper(ModuleSymbol module0)
        {
            ...
            Assert.Same(module0, module0.GlobalNamespace.Locations.Single().MetadataModule.GetSymbol());
            Assert.Same(module0, system.Locations.Single().MetadataModule.GetSymbol());
            Assert.Same(module0, runtime.Locations.Single().MetadataModule.GetSymbol());
            Assert.Same(module0, obj.Locations.Single().MetadataModule.GetSymbol());
        }
    }
}
