...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests.Symbols.Retargeting
{
    public class RetargetCustomModifiers : CSharpTestBase
    {
        ...
        public void Test1()
        {
            ...
            Assert.Same(mscorlibAssembly, f0Mod.Modifier.ContainingAssembly.GetSymbol<AssemblySymbol>());
            ...
            Assert.Same(mscorlibAssembly, p1Mod.Modifier.ContainingAssembly.GetSymbol<AssemblySymbol>());
            ...
            foreach (var p2Mod in p2.TypeWithAnnotations.CustomModifiers)
            {
                ...
                Assert.Same(mscorlibAssembly, p2Mod.Modifier.ContainingAssembly.GetSymbol<AssemblySymbol>());
            }
            ...
            Assert.Same(mscorlibAssembly, m5Mod.Modifier.ContainingAssembly.GetSymbol<AssemblySymbol>());
            ...
            Assert.Same(mscorlibAssembly, p5TypeMod.Modifier.ContainingAssembly.GetSymbol<AssemblySymbol>());
            ...
            Assert.Same(mscorlibAssembly, p6TypeMod.Modifier.ContainingAssembly.GetSymbol<AssemblySymbol>());
            ...
            Assert.Same(mscorlibAssembly, m7Mod.Modifier.ContainingAssembly.GetSymbol<AssemblySymbol>());
        }
