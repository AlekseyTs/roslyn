...
";
            ...
            Assert.IsType<SynthesizedIntrinsicOperatorSymbol>(nonNullPlus.GetSymbol<Symbol>());
            Assert.IsType<SynthesizedIntrinsicOperatorSymbol>(nullPlus.GetSymbol<Symbol>());
...
class C
{
    ...
    void M2()
    {
        ...
        s.StringExt();
            ...
            Assert.IsType<ReducedExtensionMethodSymbol>(nonNullStringExt.GetSymbol<Symbol>());
            Assert.IsType<ReducedExtensionMethodSymbol>(nullStringExt.GetSymbol<Symbol>());
...
class C
{
    void M()
    {
        ...
        local(s2);
            ...
            Assert.IsType<ConstructedMethodSymbol>(nonNullM.GetSymbol<Symbol>());
            Assert.IsType<ConstructedMethodSymbol>(nullM.GetSymbol<Symbol>());

            var nonNullOriginal = nonNullM.OriginalDefinition;
            var nullOriginal = nullM.OriginalDefinition;

            Assert.IsType<LocalFunctionSymbol>(nonNullOriginal.GetSymbol<Symbol>());
            Assert.IsType<LocalFunctionSymbol>(nullOriginal.GetSymbol<Symbol>());
...
";
            ...
            Assert.IsType<SubstitutedMethodSymbol>(nonNullSubstituted.GetSymbol<Symbol>());
            Assert.IsType<SubstitutedMethodSymbol>(nullSubstituted.GetSymbol<Symbol>());
