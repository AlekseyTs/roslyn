...
namespace Microsoft.CodeAnalysis.Emit
{
    internal abstract class DefinitionMap
    {
        ...
        private static IReadOnlyDictionary<IMethodSymbolInternal, MappedMethod> GetMappedMethods(IEnumerable<SemanticEdit> edits)
        {
            ...
            foreach (var edit in edits)
            {
                ...
                {
                    var newMethod = (edit.NewSymbol as ISymbolInternalSource)?.GetISymbolInternal() as IMethodSymbolInternal;
                    var oldMethod = (edit.OldSymbol as ISymbolInternalSource)?.GetISymbolInternal() as IMethodSymbolInternal;
