...
namespace Microsoft.CodeAnalysis.Emit
{
    ...
    public struct SemanticEdit : IEquatable<SemanticEdit>
    {
        ...
        internal SemanticEdit(SemanticEditKind kind, ISymbolInternal oldSymbol, ISymbolInternal newSymbol, Func<SyntaxNode, SyntaxNode> syntaxMap = null, bool preserveLocalVariables = false) :
            this(kind, oldSymbol?.GetISymbol(), newSymbol?.GetISymbol(), syntaxMap, preserveLocalVariables)
        {
        }
