...
namespace Microsoft.CodeAnalysis.CSharp.UnitTests
{
    public static class CompilationUtils
    {
        ...
        {
            CheckReducedExtensionMethod(reducedMethod.GetPublicSymbol<IMethodSymbol>(), reducedFrom.GetPublicSymbol<IMethodSymbol>());
        }
        ...
        {
            CheckConstructedMethod(constructedMethod.GetPublicSymbol<IMethodSymbol>(), constructedFrom.GetPublicSymbol<IMethodSymbol>());
        }
                ...
                var actualTypes = annotations.SelectAsArray(annotation =>
                    {
                        ...
                        var type = TypeWithState.Create(
                            (annotation.IsConverted ? typeInfo.ConvertedType : typeInfo.Type).GetSymbol<TypeSymbol>(),
