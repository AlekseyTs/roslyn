            ...
            <![CDATA[
{
  ...
  IL_0024:  callvirt   "Function c0.get_P1() As Integer"
  IL_0029:  ldc.i4.1
  IL_002a:  add.ovf
  IL_002b:  constrained. "T"
  IL_0031:  callvirt   "Sub c0.set_P1(Integer)"
  ...
  IL_004a:  callvirt   "Function c0.get_Item(Integer) As Integer"
  IL_004f:  ldc.i4.1
  IL_0050:  add.ovf
  IL_0051:  constrained. "T"
  IL_0057:  callvirt   "Sub c0.set_Item(Integer, Integer)"
  IL_005c:  ret
}
]]>).
